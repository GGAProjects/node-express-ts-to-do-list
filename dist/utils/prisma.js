...
db.$use(function (params, next) { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!(params.model == 'Task')) return [3, 2];
                if (!(params.action === 'findFirst')) return [3, 2];
