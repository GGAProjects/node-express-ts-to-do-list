...
exports.findById = exports.login = exports.register = void 0;
...
var login = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, findByEmail(email)];
            case 1:
                user = _a.sent();
                if (!user)
                    throw new customErrors_1.FieldsError("Wrong email or password", {
...
var findById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, prisma.user.findFirst({ where: { id: id } })];
            case 1:
                model = _a.sent();
                return [2, model];
        }
...
var findByEmail = function (email) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, prisma.user.findFirst({ where: { email: email } })];
            case 1:
                model = _a.sent();
                return [2, model];
        }
